...
1. Reference documentation or issues that are relevant to your changes.  
   For instance, if you're implementing a new Fluxer feature, include a link to the [api docs](https://docs.fluxer.app/) pull request that documents the feature.
...
1. Follow the JFA coding style, even if unconventional, we want to keep it consistent to maintain readability.
